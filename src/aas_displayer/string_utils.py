...
def convert_time_to_milli_seconds(time_str):
    """
    This function converts time str in the format of Hrs:Mins:Secs:hundredths to the amount of milliseconds passed since
    00:00:00:00.

    :param time_str: a time str with the format of Hrs:Mins:Secs:hundredths
    :type time_str: str
    :return: the amount of milliseconds passed since 00:00:00:00 this str represents as a time object.
    :rtype: dt.time
    """
    hours, minutes, seconds, hundredth = map(int, time_str.split(':'))
    microseconds = hundredth * 10000
